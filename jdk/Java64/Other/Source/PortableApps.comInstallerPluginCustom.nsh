...
!macro CustomCodePostInstall
	Rename "$INSTDIR\jre1.8.0_241\bin" "$INSTDIR\bin"
	Rename "$INSTDIR\jre1.8.0_241\lib" "$INSTDIR\lib"
	Rename "$INSTDIR\jre1.8.0_241\COPYRIGHT" "$INSTDIR\COPYRIGHT"
	Rename "$INSTDIR\jre1.8.0_241\LICENSE" "$INSTDIR\LICENSE"
	Rename "$INSTDIR\jre1.8.0_241\README.txt" "$INSTDIR\README.txt"
	Rename "$INSTDIR\jre1.8.0_241\release" "$INSTDIR\release"
	Rename "$INSTDIR\jre1.8.0_241\THIRDPARTYLICENSEREADME.txt" "$INSTDIR\THIRDPARTYLICENSEREADME.txt"
	Rename "$INSTDIR\jre1.8.0_241\THIRDPARTYLICENSEREADME-JAVAFX.txt" "$INSTDIR\THIRDPARTYLICENSEREADME-JAVAFX.txt"
	Rename "$INSTDIR\jre1.8.0_241\Welcome.html" "$INSTDIR\Welcome.html"
	RMDir "$INSTDIR\jre1.8.0_241"
